...
<div class="form-group">
   ...
   <div class="col-md-6">
      {{ Form::password('password', ['id'=>'rol_id','class'=>'form-control','required'=>'required']) }}
   </div>
</div>
<div class="form-group">
   {{ Form::label('password_confirmation', 'Confirme Contraseña', array('class' => 'col-md-2 control-label')) }}
   <div class="col-md-6">
      {{ Form::password('password_confirmation', ['id'=>'rol_id','class'=>'form-control','required'=>'required']) }}
   </div>
</div>
<div class="form-group">
   <br/>
